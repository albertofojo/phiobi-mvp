...
VALUES
  ...
  ('NAT.MC', 'Naturgy', 'Servicios Públicos', 'IBEX 35', true),
  ...
  ('LLE.MC', 'Lleida.net', 'Tecnología', 'Mercado Continuo', true),
  ('FDR.MC', 'Fluidra', 'Consumo Discrecional', 'Mercado Continuo', true),
  ...
  ('TAL.MC', 'Talgo', 'Industrial', 'Mercado Continuo', true),
  ('MEL.MC', 'Meliá Hotels', 'Consumo Discrecional', 'Mercado Continuo', true),

  -- BME Growth (Ejemplos destacados)
