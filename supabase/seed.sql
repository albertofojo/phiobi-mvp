...
-- Uses idempotent INSERT ON CONFLICT DO UPDATE pattern
...
VALUES
  ...
  ('CEL.MC', 'Cellnex Telecom, S.A.', 'Communication Services', 'IBEX 35'),
  ...
  -- Mercado Continuo
  ('ALB.MC', 'Corporación Financiera Alba, S.A.', 'Financial Services', 'Continuo'),
  ('CAF.MC', 'Construcciones y Auxiliar de Ferrocarriles, S.A.', 'Industrials', 'Continuo'),
  ('EBRO.MC', 'Ebro Foods, S.A.', 'Consumer Defensive', 'Continuo'),
  ('FCC.MC', 'Fomento de Construcciones y Contratas, S.A.', 'Industrials', 'Continuo'),
  ('PHM.MC', 'Pharma Mar, S.A.', 'Healthcare', 'Continuo'),
  ('TAL.MC', 'Talgo, S.A.', 'Industrials', 'Continuo'),
  ('TUB.MC', 'Tubacex, S.A.', 'Basic Materials', 'Continuo'),
  ('VID.MC', 'Vidrala, S.A.', 'Consumer Defensive', 'Continuo'),
  ('VIS.MC', 'Viscofan, S.A.', 'Consumer Defensive', 'Continuo'),
  ('MEL.MC', 'Meliá Hotels International, S.A.', 'Consumer Cyclical', 'Continuo'),
  ('CIE.MC', 'CIE Automotive, S.A.', 'Industrials', 'Continuo'),
  ('ENC.MC', 'Ence Energía y Celulosa, S.A.', 'Basic Materials', 'Continuo'),
  ('FAES.MC', 'Faes Farma, S.A.', 'Healthcare', 'Continuo'),
  ...
  ('ATRY.MC', 'Atrys Health, S.A.', 'Healthcare', 'BME Growth'),
  ('EIDF.MC', 'EiDF Solar', 'Utilities', 'BME Growth'),
  ('SNG.MC', 'SNGULAR', 'Technology', 'BME Growth'),
  ('ADZ.MC', 'Arteche', 'Industrials', 'BME Growth'),
  ('MIO.MC', 'Making Science', 'Technology', 'BME Growth'),
